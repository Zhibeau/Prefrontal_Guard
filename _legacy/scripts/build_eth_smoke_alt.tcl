...
set PROJDIR ${ROOT}/vivado_proj_eth_smoke_alt

file mkdir ${PROJDIR}
create_project aegis_eth_smoke_alt ${PROJDIR} -part ${PART} -force

set_property target_language  Verilog [current_project]
set_property simulator_language Mixed  [current_project]

add_files -norecurse ${ROOT}/rtl/eth_smoke_alt_top.v
set_property top eth_smoke_alt_top [current_fileset]
...
add_files -fileset constrs_1 -norecurse ${ROOT}/constraints/aegis_ax7102_eth_alt.xdc

puts "=== Starting alternate Ethernet smoke-test synthesis ==="
launch_runs synth_1 -jobs 4
wait_on_run synth_1
if {[get_property PROGRESS [get_runs synth_1]] != "100%"} {
    error "Synthesis FAILED. Check vivado_proj_eth_smoke_alt/aegis_eth_smoke_alt.runs/synth_1/runme.log"
}
puts "=== Synthesis complete ==="

puts "=== Starting alternate Ethernet smoke-test implementation ==="
set_property strategy "Performance_ExplorePostRoutePhysOpt" [get_runs impl_1]
launch_runs impl_1 -jobs 4
wait_on_run impl_1
if {[get_property PROGRESS [get_runs impl_1]] != "100%"} {
    error "Implementation FAILED. Check vivado_proj_eth_smoke_alt/aegis_eth_smoke_alt.runs/impl_1/runme.log"
}
puts "=== Implementation complete ==="

open_run impl_1
report_timing_summary -file ${ROOT}/impl/timing_eth_smoke_alt.rpt -warn_on_violation
report_utilization    -file ${ROOT}/impl/utilization_eth_smoke_alt.rpt
...
puts "=== Writing alternate Ethernet smoke-test bitstream ==="
write_bitstream -force ${ROOT}/impl/aegis_chip_alt.bit
puts "=== Alternate smoke-test bitstream written to ${ROOT}/impl/aegis_chip_alt.bit ==="
